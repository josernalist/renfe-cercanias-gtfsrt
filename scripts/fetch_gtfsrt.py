#!/usr/bin/env python3
"""
Renfe Cercanías GTFS-RT Archiver
Descarga https://gtfsrt.renfe.com/trip_updates.json
...
GTFSRT_URL = "https://gtfsrt.renfe.com/trip_updates.json"
...
def fetch() -> bytes:
    req = urllib.request.Request(
        GTFSRT_URL,
        headers={
            "User-Agent": "renfe-cercanias-gtfsrt-archiver/1.0",
...
def parse_trip_id(trip_id: str) -> tuple:
    import re
    tren = trip_id[:5] if len(trip_id) >= 5 else trip_id
